...
// Auto-incrementing index for ad-hoc wallets (3+ since 0-2 are agents)
let nextWalletIndex = 3;

/**
 * POST /wallet/create
 * Create a new wallet (derives next BIP-44 account)
 */
...
router.post('/create', async (req, res) => {
  try {
    ...
    const wallet = await walletService.createWallet(value.name, index);
